...
public sealed class LocalFileSystemFileIntegrityVerifier : BaseFileIntegrityVerifier
{
        ...
        TrackedFiles trackedFiles)
    {
        ...
        var pathExists = trackedFiles.PathExists(relativePath.Value);
        var checksumExists = trackedFiles.ChecksumExists(checksum.Value);
        var checksumVerified = trackedFiles.ChecksumMatches(relativePath.Value, checksum.Value);
