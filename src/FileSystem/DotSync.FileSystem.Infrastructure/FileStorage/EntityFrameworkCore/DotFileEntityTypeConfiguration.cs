...
public sealed class DotFileEntityTypeConfiguration : IEntityTypeConfiguration<DotFile>
{
    public void Configure(EntityTypeBuilder<DotFile> builder)
    {
        ...
        builder
            ...
            .WithMany(e => e.Files)
            .UsingEntity<StoredFile>(
                l => l.HasOne<StorageLocation>().WithMany().HasForeignKey(Constants.StoredFiles.StorageLocationForeignKey),
                r => r.HasOne<DotFile>().WithMany().HasForeignKey(Constants.StoredFiles.FileForeignKey));
